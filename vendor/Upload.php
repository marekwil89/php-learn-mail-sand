 ...
 *
 * @author Aivis Silins https://github.com/aivis/PHP-file-upload-class
 */
class Upload {
	...
	public function set_filename($filename) {
		...
		$this->filename = $filename.'.'.$file_type;
	...
	function file_type(){
		...
		return $original_filename = $original_filename.end($extension);
	}
